...
[discrete]
= TestModell (T001)
Sie befinden sich auf der Startseite des Themas **"TestModell (T001)"**. Über folgende Links gelangen Sie zu weiteren Informationen:

* https://ch-sz-geo.github.io/T001/[Daten, Datenmodell, Modellbeschreibung, Erfassungsrichtlinie usw.] zu diesem Thema
